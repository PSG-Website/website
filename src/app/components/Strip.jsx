...
import openModal from './Upcoming'
function Strip({onclick}){
    return(
        <div id='card' className="card md:m-0 hover:cursor-pointer relative left-0 md:w-[70px] rounded-lg md:h-[450px] overflow-hidden shadow-[0_5px_12px_rgba(0,0,0,0.5)] bg-[#576CBC] 
                ...
                hover:mt-[-20px] hover:duration-500 even:hover:mt-[30px] [&:nth-child(3n)]:hover:mt-[80px] " onClick={onclick}>  
                <a  href="#">
